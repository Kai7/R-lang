---
title: 'Lecture 13: Principal component and factor analyses'
...
## RMD_example 13.1: Read 分類熱門照片 (picture.csv)

```{r}
# get the file url for the data
fileurl = 'http://ghuang.stat.nctu.edu.tw/course/statmethods16/files/data/picture.csv'
# import the csv file into R
#   note: stringsAsFactors=TRUE will screw up conversion to numeric!
picture<-read.csv(fileurl, header=TRUE, stringsAsFactors=FALSE)
dim(picture)
head(picture)
...
## RMD_example 13.2: PCA using the covariance matrix (original measurements)
...
## RMD_example 13.3: PCA using the correlation matrix (standardized variables)
...
## RMD_example 13.4: Factor analysis
